...
const MaterialNode: React.FC<IMaterialNodeProps> = (props) => {
  ...
  const computedStyle: React.CSSProperties = {
    gridRow: props.material.rowSpan ? `span ${props.material.rowSpan}` : undefined,
    gridColumn: props.material.columnSpan ? `span ${props.material.columnSpan}` : undefined,
  }
    ...
    >
      {
        MaterialNode?(
          ...
          <Default icon={props.icon} label={props.material.label} className={classNames({ 'span': props.material.rowSpan || props.material.columnSpan })} />
        )
      }
    </div>
  );
